...
#
# Description:
#   This script will remove a series of packages in order to obtain a minimal Linux Bodhi 7.0.
#
...
#
# IMPORTANT:
#   The script is separated into multiple purge command, to avoid unment dependency error 
#
